<?php
/** File: CoffeePot Chat (Room class)
 * 
 * @version 1.5  #rv-{versions}, Author Rexzooly Black <copyright (c) 2023, rexzooly.co.uk>
 * @original version 1.4  #jv-{versions}, Author Joao Ferreira <copyright (c) 2018, Joao Ferreira(jflei@sapo.pt)>
 */
class WcRoom {
